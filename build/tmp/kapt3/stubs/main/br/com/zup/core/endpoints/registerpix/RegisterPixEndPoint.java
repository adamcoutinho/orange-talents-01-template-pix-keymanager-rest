...
public class RegisterPixEndPoint {
    ...
    @io.micronaut.http.annotation.Post(value = "/{client-id}/cpf")
    ...
    @io.micronaut.http.annotation.Post(value = "/{client-id}/email")
    ...
    @io.micronaut.http.annotation.Post(value = "/{client-id}/phone")
    ...
    @io.micronaut.http.annotation.Post(value = "/{client-id}")
